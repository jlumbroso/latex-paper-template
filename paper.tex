...
%% ============================================
%
% NOTE: The acmart class already loads many common packages including:
% - natbib, graphicx, booktabs, url, hyperref
% - amsmath, amsfonts, amssymb (via amsart)
% - geometry, xcolor, caption, float
% Do not reload these packages or LaTeX will give "Option clash" errors.

% Typography packages not loaded by acmart
% (times, helvet, courier are loaded by acmart's font system)
\frenchspacing

% Set URL style (acmart already loads url package)
\urlstyle{rm}

% Additional algorithm packages
\usepackage{algorithm}
\usepackage{algorithmic}

% Additional useful packages
\usepackage{pifont}       % For special symbols like \ding
\usepackage{subfig}       % For subfigures

% Comment package for conditional compilation
\usepackage{comment}
...
% Customize caption formatting (acmart loads caption package already)
\captionsetup{font=small,labelfont=bf,textfont=normal}

% Page setup (acmart handles most of this, but we can set these)
